    ...
    if exist(grp_proc_info_in.beapp_fname_all{curr_file},'file')
        ...
        if exist('eeg_w','var')
                ...
                if size(eeg_w{curr_condition},1)>0
                    for curr_chan=1:size(eeg_w{curr_condition},1)
                        if ismember(curr_chan,file_proc_info.beapp_indx{1,1})
                            ...
                            %the first stim
                            %'winsize',floor(grp_proc_info_in.beapp_itpc_ersp_params.win_size*file_proc_info.beapp_srate)
                            %if curr_chan==1 %TEMP (for speed)
                            if grp_proc_info_in.beapp_itpc_ersp_params.baseline_norm == 1
                                if grp_proc_info_in.beapp_itpc_ersp_params.use_common_baseline
                                    if curr_condition == grp_proc_info_in.beapp_itpc_ersp_params.common_baseline_idx
                                        if grp_proc_info_in.beapp_itpc_ersp_params.set_freq_range
                                            [~,~,powbase{curr_condition,1}(curr_chan,:),t_powbase,f_powbase]...
                                                ...
                                                file_proc_info.beapp_srate,[grp_proc_info_in.beapp_itpc_ersp_params.min_cyc grp_proc_info_in.beapp_itpc_ersp_params.max_cyc],...
                                                'freqs',[grp_proc_info_in.beapp_itpc_ersp_params.min_freq grp_proc_info_in.beapp_itpc_ersp_params.max_freq],...
                                        ...
                                        powbase{curr_condition,1}(curr_chan,:) = powbase{grp_proc_info_in.beapp_itpc_ersp_params.common_baseline_idx,1}(curr_chan,:);
                                    end
                                else
                                ...
                                if grp_proc_info_in.beapp_itpc_ersp_params.set_freq_range
                                    [ERSP{curr_condition,1}(curr_chan,:,:),eeg_itc{curr_condition,1}(curr_chan,:,:),powbase_2{curr_condition,1}(curr_chan,:),t{curr_condition,1},f{curr_condition,1},~,~]...
                                        ...
                                        [grp_proc_info_in.evt_analysis_win_start*1000 grp_proc_info_in.evt_analysis_win_end*1000],...
                                        file_proc_info.beapp_srate,[grp_proc_info_in.beapp_itpc_ersp_params.min_cyc grp_proc_info_in.beapp_itpc_ersp_params.max_cyc],...  
                                        'freqs',[grp_proc_info_in.beapp_itpc_ersp_params.min_freq grp_proc_info_in.beapp_itpc_ersp_params.max_freq],'powbase',powbase{curr_condition,1}(curr_chan,:),'itctype','phasecoher',...
                                ...
                                if grp_proc_info_in.beapp_itpc_ersp_params.set_freq_range
                                    [ERSP{curr_condition,1}(curr_chan,:,:),eeg_itc{curr_condition,1}(curr_chan,:,:),powbase_2{curr_condition,1}(curr_chan,:),t{curr_condition,1},f{curr_condition,1},~,~]...
                                        ...
                                        [grp_proc_info_in.beapp_itpc_ersp_params.min_freq grp_proc_info_in.beapp_itpc_ersp_params.max_freq],...
                                        'plotmean','off','plotersp','off','plotitc','off','plotphasesign','off','plotphaseonly','off','verbose',...
                                        'off');
            ...
            if ~all(cellfun(@isempty,eeg_itc))
                if exist('powbase_2') && (grp_proc_info_in.beapp_itpc_ersp_params.baseline_norm == 1)%if powbase_2 exists, powbase was set to be NaN for input, and powbase_2 contains actual output
                    powbase = powbase_2;
                end
